...
/// The `LocationSoybeanPage` widget displays options related to Soybean locations.
class LocationSoybeanPage extends StatefulWidget {
  const LocationSoybeanPage({super.key});

  @override
  State<LocationSoybeanPage> createState() => _LocationSoybeanPageState();
}

/// The `_LocationSoybeanPageState` manages the state for the `LocationSoybeanPage` widget.
class _LocationSoybeanPageState extends State<LocationSoybeanPage> {
